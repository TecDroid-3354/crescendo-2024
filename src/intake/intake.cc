...
intake::intake(k::intake_settings settings_)
...
auto
intake::set_velocity(units::velocity::meters_per_second_t velocity_) -> void {
    _pid_controller.SetReference(velocity_.value(),
                                 rev::CANSparkMax::ControlType::kVelocity);
}

auto
intake::set_percentage(double percentage_) -> void {
